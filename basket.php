            ...
            <div class="container-fluid" id="section_diapo" style="padding-left: 0px;padding-right: 0px;">
                <div id="diapo_" class="carousel slide carousel-fade" data-ride="carousel" data-interval="3000">
                    <div class="carousel-item active">
                        <img src="Images/basket/diapo/1.jpg" class="d-block w-100">
                    </div>

                    <div class="carousel-item">
                        <img src="Images/basket/diapo/2.jpg" class="d-block w-100">
                    </div>

                    <div class="carousel-item">
                        <img src="Images/basket/diapo/3.jpg" class="d-block w-100">
                    </div>

                    <div class="carousel-item">
                        <img src="Images/basket/diapo/4.jpg" class="d-block w-100">
                    </div>

                    <div class="carousel-item">
                        <img src="Images/basket/diapo/5.jpg" class="d-block w-100">
                    </div>

                    <div class="carousel-item">
                        <img src="Images/basket/diapo/6.jpg" class="d-block w-100">
                    </div> 
            </div>
        </div>
        </header>
        <section id="tabs" class="container">
            <div class="row">
                    ...
                    <div>
                        <nav>
                            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                ...
                                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">U19 FIBA 2021</a>
                                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-profile" aria-selected="false">Statistiques</a>
                        ...
                        <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                ...
                                <br/>
                                <div class="champ_detail champ_detail_basket"> 
                                   <br/>
                                    <div class="row">
                                        <div class="col-md-4">
                ...
                <div class="d-flex flex-column" id="poules" style="background-color: none;">
                    ...
                    <button class="btn btn-light btn-sm " data-toggle="collapse" data-target="#p_1" ">Match<br/>U19 FIBA 2021 </button>
                    ...
                    <button class="btn btn-light btn-sm" data-toggle="collapse" data-target="#p_2" ">Classement U19 FIBA 2021<br/>Ligue 1 Orange </button>
